package org.ladder.segmentation.fssSegmenter;
...
import org.ladder.segmentation.shortstraw.IShortStrawThresholds;
...
public class FSSSegmenter extends SezginSegmenter {
	...
	private List<Integer> getInitialCorners_ShortStrawOversegment()
		...
		IStroke resampledStroke = new Stroke(m_stroke);
		...
		// Resample the stroke
			...
			List<IPoint> points = resamplePoints(resampledStroke,
					resampledSpacing);
	 ...
	 */
	private List<IPoint> resamplePoints(IStroke s, double interspacing) {
